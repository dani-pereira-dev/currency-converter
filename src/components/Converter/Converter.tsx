...
import { Container, ExchangeRatePerUnit, LastUpdate, ResultContainer, Value, styles } from "./style"
    ...
    <Card elevation={3} style={styles.card} className="card">
      ...
      <ResultContainer>
          ...
          <Alert severity="info" icon={false} style={styles.warningBox}>
            We use the mid-market rate for our Converter. This is for informational <br/> 
